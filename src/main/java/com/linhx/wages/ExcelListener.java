...
public class ExcelListener extends AnalysisEventListener {
     ...
     * 可以通过实例获取该值
     */
    private List<ExcelMode> datas = new ArrayList<>();
    ...
    public void invoke(Object object, AnalysisContext context) {
        @SuppressWarnings("unchecked") ExcelMode excelMode = (ExcelMode) object;
        String teachDate = excelMode.getTeachDate();
        ...
        excelMode.setHours(b);

        // 处理金额
        Integer studentCount = excelMode.getStudentCount();
        String teachName = excelMode.getTeachName();
        BigDecimal hours = excelMode.getHours();
        if (studentCount == 0) {
            excelMode.setMoney(new BigDecimal(0));
     ...
     * @return 返回读取的数据集合
     **/
    public List<ExcelMode> getDatas() {
        return datas;
    }
     ...
     **/
    public void setDatas(List<ExcelMode> datas) {
        this.datas = datas;
    }
}
